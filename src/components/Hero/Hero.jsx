    ...
    <section className="hero">
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          Zeven vrienden, één ploeg. Zeven amateurs die meedoen aan verschillende sporttoernooien met bloed zweet en mss een pintje.
        </p>

        <div className="hero-stats">
          <div className="stat">
            <span className="stat-number">0</span>
            <span className="stat-label">Toernooien</span>
          </div>
          <div className="stat">
            <span className="stat-number">0</span>
